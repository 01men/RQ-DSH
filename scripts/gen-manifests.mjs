...
const PLUGINS = [
  ...
  },
  {
    ...
    api: [
      ...
      'GET /api/panel/stream?dept=&token=（SSE；EventSource 无法带 Bearer，端点内部自校验 fail-closed）',
    ...
    tools: ['panel_agents_list', 'panel_msg_send', 'panel_task_create', 'panel_task_transition', 'panel_scene_diag', 'panel_widget_data'],
    ui: {
