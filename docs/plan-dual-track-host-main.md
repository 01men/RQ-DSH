...
| 区 | 目录 | 规则 |
|---|---|---|
| 宿主面（main 拥有并演进） | platform-core、plugin-console、plugin-authn、plugin-agent、plugin-portal、plugin-iam、plugin-usage、plugin-skillhub、plugin-app、plugin-mcp、nas-authz、**plugin-dsh-bridge（宿主桥=宿主入口设施）**、src/boot-all.ts、cordis.yml | 自由演进；契约变更履行 §4 义务 |
...
| 治理/胶水（定制侧所有） | AGENTS.md、PROJECT.md、scripts/hooks、cordis.patch.yml、docs/handoff-* | main 不消费 |
