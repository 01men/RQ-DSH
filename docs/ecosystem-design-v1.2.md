...
> 平台商业模式已按 M0（2026-09-09）收敛为「私有化年费 + 治理包」，对外只呈现用量透明计量与内部成本穿透，
> 价格簿为零价快照。现行口径以 [release-notes-2026-09-09-m0.md](release-notes-2026-09-09-m0.md) 与
> [contract-j4-usage-report.md](contract-j4-usage-report.md) 为准；本文仅保留计量管道、市场契约等仍然有效的部分作参考。
